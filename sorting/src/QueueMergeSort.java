...
public class QueueMergeSort
{
    ...
    public static <K> void merge(Queue<K> S1, Queue<K> S2, Queue<K> S, Comparator<K> comp) throws QueueEmptyException, QueueFullException
    {
    ...
    public static <K> void mergeSort(Queue<K> S, Comparator<K> comp) throws QueueEmptyException, QueueFullException
    {
        int n = S.size();
