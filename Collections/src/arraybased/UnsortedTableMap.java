...
public class UnsortedTableMap<K,V> extends AbstractMap<K,V>
{
    ...
    // Returns the value associated with the speciﬁed key (or else null). ∗/
    public V get(K key)
    {
        int j = ﬁndIndex(key);
    ...
    // Removes the entry with the speciﬁed key (if any) and returns its value.
